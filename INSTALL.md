# mk-piclock v1.9.17-rpi-zero-r3: Build and Install
...
For this v1.9.17-rpi-zero-r3 release:

```bash
cd ~
sha256sum -c mk-piclock-v1.9.17-rpi-zero-r3-release.zip.sha256
rm -rf mk-piclock-v1.9.17-rpi-zero-r3
unzip mk-piclock-v1.9.17-rpi-zero-r3-release.zip
cd mk-piclock-v1.9.17-rpi-zero-r3
```

A successful checksum test reports:

```text
mk-piclock-v1.9.17-rpi-zero-r3-release.zip: OK
```
